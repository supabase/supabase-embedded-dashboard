  ...
  return (
    <div>
      <div className="px-6 pt-4 lg:px-8 lg:pt-8">
        ...
        <div>
          {isNaturalLanguageMode && (
            <div className="flex items-center mb-4 gap-4 border rounded-md bg-muted/50 border shadow pl-4 pr-1">
              ...
              <Input
                ...
                className="bg-transparent border-none rounded-none px-0 py-4 shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 text-sm lg:text-base"
              />
              <Button
