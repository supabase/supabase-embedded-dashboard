...
import { SuggestionsManager } from "./suggestions";
...
import { LogoSupabase } from "../logo-supabase";
    ...
    return (
      <QueryClientProvider client={queryClient}>
        <Dialog open={open} onOpenChange={onOpenChange}>
          <DialogContent className="w-full h-[80vh] max-w-[1198px] min-w-4xl max-h-[700px] min-h-4xl p-0 overflow-hidden sm:rounded-lg">
